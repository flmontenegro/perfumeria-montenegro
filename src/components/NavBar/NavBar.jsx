...
<nav className="bg-zinc-100 border-gray-200 px-2 sm:px-4 py-2.5 rounded ">
  ...
  <ul class="dropdown-menu absolute hidden text-gray-700 pt-1">
    <li class=""><Link to={"/category/CH"} class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="/">Carolina Herrera</Link></li>
    <li class=""><Link to={"/category/Dior"} class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="/">Dior</Link></li>
    <li class=""><Link to={"/category/Channel"} class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="/">Channel</Link></li>
  </ul>
</div>
      </li>
        <li>

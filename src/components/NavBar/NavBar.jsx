...
>>>>>>> 34f444755444a68668175ba48042dbf74e319b96
    ...
    <div className="hidden w-full md:block md:w-auto" id="mobile-menu">
      ...
      <li>
          <a href="index.html" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-black md:dark:hover:text-gray-700 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">HOME</a>
        </li>
        <li>

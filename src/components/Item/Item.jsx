...
export default function Item ({id, title, pictureUrl, category}) { 
return ( 
  ...
  <div className={"p-5"}> 
  <h5 className={"mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black"}>{title} - {id} {category}</h5>
  <button>

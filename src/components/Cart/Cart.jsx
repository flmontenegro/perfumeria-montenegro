...
import img from "../img/perfu-rose.png"
...
export default function Cart() {
    ...
    return (
        cart.length === 0 ? (
            <> <h1 className={'text-[25px] lg:text-[50px] xl:text-[50px] 2xl:text-[50px] font-semibold text-zinc-500 font-serif'}>SU CARRITO ESTA VACIO</h1>
            <Link to={`/`} type="button"  className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-indigo-800 dark:hover:bg-green-500 dark:focus:ring-blue-800"><svg class="w-5 h-5 mr-2 -ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path></svg> COMPRAR</Link>
            <div className='flex justify-center'>
            <img className=" py-8" src={img} alt="perf" />
            </div>
            </> ): (
        <>
    <div className='flex justify-center py-8'>
    <div className=" flex flex-col lg:max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-800 dark:text-gray-100">
...
{row.cantidad}
                ...
                <div className="flex justify-center md:justify-end lg:justify-end md:space-x-4 ">
                        ...
                        <Link to="/" type="button" className="px-6 py-2 border rounded-md dark:border-violet-400">
                            <span className=" ">Agregar mas productos</span>
                        </Link>
                        <Link to="/checkOut" type="button" className="px-6 py-2 border rounded-md bg-blue-700  focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-indigo-800 dark:hover:bg-green-500 dark:focus:ring-blue-800">
                            <span className="">FINALIZAR COMPRA</span>
                        </Link>
                </div>

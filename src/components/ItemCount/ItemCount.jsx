...
return (
    ...
    <div className="space-x-4 mb-3 flex flex-row justify-center btn__container">
      ...
      <button type="button" onClick={onAdd} className="text-white  inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
